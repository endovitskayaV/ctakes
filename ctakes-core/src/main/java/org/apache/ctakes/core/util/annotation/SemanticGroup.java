...
public enum SemanticGroup {
   ...
   PHARM_SUBSTANCE(NE_TYPE_ID_PHARM_SUBSTANCE, "Pharmacologic Substance", "Pharmacologic Substance", PharmSubstanceMention.class, PharmSubstanceMention::new ),
   BIO_SUBSTANCE(NE_TYPE_ID_BIO_SUBSTANCE, "Biologically Active Substance", "Biologically Active Substance", BioSubstanceMention.class, BioSubstanceMention::new ),
